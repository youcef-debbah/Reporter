...
internal sealed class AbstractReadOrWriteMutex(
    ...
    companion object {
        ...
        const val ON_LOCK_DEPRECATION_MESSAGE = "Mutex.onLock deprecated without replacement. For additional details please refer to #2794"
    }

    @Deprecated(
        message = ON_LOCK_DEPRECATION_MESSAGE,
        level = DeprecationLevel.WARNING,
        replaceWith = ReplaceWith(""),
    )
    override val onLock: SelectClause2<Any?, Mutex>
        get() = throw RuntimeException(ON_LOCK_DEPRECATION_MESSAGE)
